...
description: 进入 explore 模式，作为思考伙伴一起探索想法、调查问题、澄清需求。适用于用户想在 change 前或进行中先想清楚问题。
license: MIT
...
- **进入 proposal 阶段**：`"Ready to start? I can create a change proposal."`
- **更新 artifacts**：`"Updated design.md with these decisions"`
- **Just provide clarity**：用户想清楚了，然后继续自己的工作
